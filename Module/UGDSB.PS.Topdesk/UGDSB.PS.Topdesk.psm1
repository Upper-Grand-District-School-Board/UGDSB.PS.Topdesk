...
#Region '.\Public\Add-TopdeskOperatorFilterBranch.ps1' 0
function Add-TopdeskOperatorFilterBranch{
  [OutputType([System.Collections.Generic.List[PSCustomObject]])]
  param(
    [Parameter(Mandatory = $true)][string]$id,
    [Parameter(Mandatory = $true)][string]$filter_id
  )
  $endpoint = "/tas/api/operators/id/$($id)/filters/branch"
...
#EndRegion '.\Public\Add-TopdeskOperatorFilterBranch.ps1' 20
#Region '.\Public\Add-TopdeskOperatorFilterCategory.ps1' 0
...
#EndRegion '.\Public\Add-TopdeskOperatorFilterCategory.ps1' 20
#Region '.\Public\Add-TopdeskOperatorFilterOperator.ps1' 0
function Add-TopdeskOperatorFilterOperator{
  [OutputType([System.Collections.Generic.List[PSCustomObject]])]
  param(
    [Parameter(Mandatory = $true)][string]$id,
    [Parameter(Mandatory = $true)][string]$filter_id
  )
  $endpoint = "/tas/api/operators/id/$($id)/filters/operator"
  $body = [System.Collections.Generic.List[PSCustomObject]]@()
  $body.Add(@([PSCustomObject]@{
    id = $filter_id
  }))
...
#EndRegion '.\Public\Add-TopdeskOperatorFilterOperator.ps1' 20
#Region '.\Public\Add-TopdeskOperatorOperatorGroup.ps1' 0
function Add-TopdeskOperatorOperatorGroup{
  [OutputType([System.Collections.Generic.List[PSCustomObject]])]
  param(
    [Parameter(Mandatory = $true)][string]$id,
...
#EndRegion '.\Public\Add-TopdeskOperatorOperatorGroup.ps1' 20
#Region '.\Public\Add-TopdeskOperatorPermissionGroup.ps1' 0
...
#EndRegion '.\Public\Add-TopdeskOperatorPermissionGroup.ps1' 20
    ...
    switch ($ErrorMsg.Exception.StatusCode) {
      ...
      "BadRequest" {
        ...
        switch ($InnerError.errorCode) {
          ...
          "Archiving reason not available" {
            $terminatingError = $false
            Write-Error "Archiving reason not available"
          }          
          default {
            $terminatingError = $true
            throw $InnerError
...
#EndRegion '.\Public\Get-TopdeskAPIResponse.ps1' 83
...
#Region '.\Public\Get-TopdeskCurrentOperator.ps1' 0
...
#EndRegion '.\Public\Get-TopdeskCurrentOperator.ps1' 23
...
#Region '.\Public\Get-TopdeskLocationBuildingZones.ps1' 0
function Get-TopdeskLocationBuildingZones{
  [cmdletbinding()]
  [OutputType([System.Collections.Generic.List[PSCustomObject]])]
  param(
  )  
  # The endpoint to get assets
  $endpoint = "/tas/api/locations/building_zones"
  try {
    # Array to hold results from the API call
    $data = [System.Collections.Generic.List[PSObject]]@()
    $uri = $endpoint
...
#EndRegion '.\Public\Get-TopdeskLocationBuildingZones.ps1' 30
#Region '.\Public\Get-TopdeskLocationCeilingCoverings.ps1' 0
function Get-TopdeskLocationCeilingCoverings{
  [cmdletbinding()]
  [OutputType([System.Collections.Generic.List[PSCustomObject]])]
  param(
  )  
  # The endpoint to get assets
  $endpoint = "/tas/api/locations/ceiling_coverings"
  try {
    # Array to hold results from the API call
    $data = [System.Collections.Generic.List[PSObject]]@()
    $uri = $endpoint
...
#EndRegion '.\Public\Get-TopdeskLocationCeilingCoverings.ps1' 30
#Region '.\Public\Get-TopdeskLocationFloorCoverings.ps1' 0
...
#EndRegion '.\Public\Get-TopdeskLocationFloorCoverings.ps1' 30
#Region '.\Public\Get-TopdeskLocationFunctionalUses.ps1' 0
function Get-TopdeskLocationFunctionalUses{
  [cmdletbinding()]
  [OutputType([System.Collections.Generic.List[PSCustomObject]])]
  param(
  )  
  # The endpoint to get assets
  $endpoint = "/tas/api/locations/functional_uses"
  try {
    # Array to hold results from the API call
    $data = [System.Collections.Generic.List[PSObject]]@()
    $uri = $endpoint
...
#EndRegion '.\Public\Get-TopdeskLocationFunctionalUses.ps1' 30
#Region '.\Public\Get-TopdeskLocationGlassMaterials.ps1' 0
function Get-TopdeskLocationGlassMaterials{
  [cmdletbinding()]
  [OutputType([System.Collections.Generic.List[PSCustomObject]])]
  param(
  )  
  # The endpoint to get assets
  $endpoint = "/tas/api/locations/glass_materials"
  try {
    # Array to hold results from the API call
    $data = [System.Collections.Generic.List[PSObject]]@()
    $uri = $endpoint
...
#EndRegion '.\Public\Get-TopdeskLocationGlassMaterials.ps1' 30
#Region '.\Public\Get-TopdeskLocations.ps1' 0
...
#EndRegion '.\Public\Get-TopdeskLocations.ps1' 44
#Region '.\Public\Get-TopdeskLocationsSearchList.ps1' 0
function Get-TopdeskLocationsSearchList{
  [CmdletBinding()]
  [OutputType([System.Collections.Generic.List[PSObject]])]
  param(
    [Parameter()][int[]]$tab = @(1, 2),
  ...
  foreach ($t in $tab) {
    ...
    foreach ($list in $searchList) {
      #$list
      $endpoint = "/tas/api/locations/free_fields/$($t)/searchlists/$($list)"
      # Generate the final API endppoint URI
      $endpoint = "$($endpoint)?$($uriparts -join "&")"      
      try {
        # Execute API Call
...
#EndRegion '.\Public\Get-TopdeskLocationsSearchList.ps1' 52
...
#Region '.\Public\Get-TopdeskOperatorFilterBranch.ps1' 0
...
#EndRegion '.\Public\Get-TopdeskOperatorFilterBranch.ps1' 21
#Region '.\Public\Get-TopdeskOperatorFilterCategory.ps1' 0
...
#EndRegion '.\Public\Get-TopdeskOperatorFilterCategory.ps1' 21
#Region '.\Public\Get-TopdeskOperatorFilterOperator.ps1' 0
...
#EndRegion '.\Public\Get-TopdeskOperatorFilterOperator.ps1' 22
#Region '.\Public\Get-TopdeskOperatorGroupOperators.ps1' 0
...
#EndRegion '.\Public\Get-TopdeskOperatorGroupOperators.ps1' 16
...
#Region '.\Public\Get-TopdeskOperatorGroupsLookup.ps1' 0
...
#EndRegion '.\Public\Get-TopdeskOperatorGroupsLookup.ps1' 49
...
#EndRegion '.\Public\Get-TopdeskOperators.ps1' 49
#Region '.\Public\Get-TopdeskOperatorsLookup.ps1' 0
function Get-TopdeskOperatorsLookup{
  [cmdletbinding()]
  [OutputType([System.Collections.Generic.List[PSCustomObject]])]
  param(
    [Parameter()][string]$id,
    ...
    [Parameter()][switch]$all,
    [Parameter()][string]$role,
    [Parameter()][string]$operatorgroupid,
    [Parameter()][bool]$includeServicePrincipals
  )
  # The endpoint to get assets
  $endpoint = "/tas/api/operators/lookup"
  if ($PSBoundParameters.ContainsKey("id")) {
    $endpoint = "$($endpoint)/$($id)"
  }   
  # Create a list of the URI parts that we would add the to the endpoint
  ...
  if ($PSBoundParameters.ContainsKey("all")) { $uriparts.add("`$all=$($all.IsPresent)") } 
  if ($PSBoundParameters.ContainsKey("role")) { $uriparts.add("role=$($role)") } 
  if ($PSBoundParameters.ContainsKey("operatorgroupid")) { $uriparts.add("operatorgroupid=$($operatorgroupid)") } 
  if ($PSBoundParameters.ContainsKey("includeServicePrincipals")) { $uriparts.add("includeServicePrincipals=$($includeServicePrincipals)") } 
  # Generate the final API endppoint URI
  $endpoint = "$($endpoint)?$($uriparts -join "&")"  
  $data = [System.Collections.Generic.List[PSObject]]@()
  try{
...
#EndRegion '.\Public\Get-TopdeskOperatorsLookup.ps1' 51
#Region '.\Public\Get-TopdeskOperatorsSearchList.ps1' 0
function Get-TopdeskOperatorsSearchList{
  [CmdletBinding()]
  [OutputType([System.Collections.Generic.List[PSObject]])]
  param(
    [Parameter()][int[]]$tab = @(1, 2),
  ...
  foreach ($t in $tab) {
    ...
    foreach ($list in $searchList) {
      #$list
      $endpoint = "/tas/api/operators/free_fields/$($t)/searchlists/$($list)"
      # Generate the final API endppoint URI
      $endpoint = "$($endpoint)?$($uriparts -join "&")"      
      try {
        # Execute API Call
...
#EndRegion '.\Public\Get-TopdeskOperatorsSearchList.ps1' 52
#Region '.\Public\Get-TopdeskPermissionGroup.ps1' 0
...
#EndRegion '.\Public\Get-TopdeskPermissionGroup.ps1' 16
#Region '.\Public\Get-TopdeskPersonGroup.ps1' 0
function Get-TopdeskPersonGroup{
  [cmdletbinding()]
  [OutputType([System.Collections.Generic.List[PSCustomObject]])]
  param(
    [Parameter()][string]$id,
...
#EndRegion '.\Public\Get-TopdeskPersonGroup.ps1' 46
#Region '.\Public\Get-TopdeskPersonGroupLookup.ps1' 0
function Get-TopdeskPersonGroupsLookup{
  [CmdletBinding()]
  [OutputType([System.Collections.Generic.List[PSObject]])]
  param(
    [Parameter()][string]$id,
  ...
  # The endpoint to get assets
  $endpoint = "/tas/api/persongroups/lookup"
  if ($PSBoundParameters.ContainsKey("id")) {
    $endpoint = "$($endpoint)/$($id)"
  }   
  # Create a list of the URI parts that we would add the to the endpoint
...
#EndRegion '.\Public\Get-TopdeskPersonGroupLookup.ps1' 45
...
#EndRegion '.\Public\Get-TopdeskPersonsLookup.ps1' 46
...
#Region '.\Public\Get-ToperdeskOperatorOperatorGroups.ps1' 0
...
#EndRegion '.\Public\Get-ToperdeskOperatorOperatorGroups.ps1' 23
#Region '.\Public\Get-ToperdeskOperatorPermissionGroups.ps1' 0
...
#EndRegion '.\Public\Get-ToperdeskOperatorPermissionGroups.ps1' 22
...
function New-TopdeskKnowledgeItem {
  ...
  if (-not $PSBoundParameters.ContainsKey("body")) {
    ...
    if ($PSBoundParameters.ContainsKey("parent")) {
      $body.Add("parent",@{number = $parent}) | Out-Null
    }
...
#Region '.\Public\New-TopdeskOperator.ps1' 0
function New-TopdeskOperator{
  ...
  param(
    ...
    [Parameter(Mandatory = $true)][String]$department_id,
    [Parameter()][String]$budgetHoldert_id,
    [Parameter()][String]$employeeNumber,
    [Parameter()][double]$hourlyRate,
    [Parameter(Mandatory = $true)][String]$networkLoginName,
...
#EndRegion '.\Public\New-TopdeskOperator.ps1' 143
#Region '.\Public\New-TopdeskOperatorGroup.ps1' 0
...
#EndRegion '.\Public\New-TopdeskOperatorGroup.ps1' 50
#Region '.\Public\New-TopdeskPerson.ps1' 0
...
#EndRegion '.\Public\New-TopdeskPerson.ps1' 128
...
#Region '.\Public\Remove-TopdeskOperatorFilterBranch.ps1' 0
function Remove-TopdeskOperatorFilterBranch{
  [OutputType([System.Collections.Generic.List[PSCustomObject]])]
  param(
    [Parameter(Mandatory = $true)][string]$id,
    [Parameter(Mandatory = $true)][string]$filter_id
...
#EndRegion '.\Public\Remove-TopdeskOperatorFilterBranch.ps1' 20
#Region '.\Public\Remove-TopdeskOperatorFilterCategory.ps1' 0
function Remove-TopdeskOperatorFilterCategory{
  [OutputType([System.Collections.Generic.List[PSCustomObject]])]
  param(
    [Parameter(Mandatory = $true)][string]$id,
    [Parameter(Mandatory = $true)][string]$filter_id
...
#EndRegion '.\Public\Remove-TopdeskOperatorFilterCategory.ps1' 20
#Region '.\Public\Remove-TopdeskOperatorFilterOperator.ps1' 0
function Remove-TopdeskOperatorFilterOperator{
  [OutputType([System.Collections.Generic.List[PSCustomObject]])]
  param(
    [Parameter(Mandatory = $true)][string]$id,
    [Parameter(Mandatory = $true)][string]$filter_id
...
#EndRegion '.\Public\Remove-TopdeskOperatorFilterOperator.ps1' 20
#Region '.\Public\Remove-TopdeskOperatorOperatorGroup.ps1' 0
...
#EndRegion '.\Public\Remove-TopdeskOperatorOperatorGroup.ps1' 20
#Region '.\Public\Remove-TopdeskOperatorPermissionGroup.ps1' 0
...
#EndRegion '.\Public\Remove-TopdeskOperatorPermissionGroup.ps1' 20
...
#Region '.\Public\Set-TopdeskAssetArchive.ps1' 0
...
#EndRegion '.\Public\Set-TopdeskAssetArchive.ps1' 20
...
#EndRegion '.\Public\Set-TopdeskAssetUnarchive.ps1' 16
...
#Region '.\Public\Set-TopdeskOperator.ps1' 0
...
#EndRegion '.\Public\Set-TopdeskOperator.ps1' 144
#Region '.\Public\Set-TopdeskOperatorArchive.ps1' 0
function Set-TopdeskOperatorArchive{
  [cmdletbinding()]
  [OutputType([System.Collections.Generic.List[PSCustomObject]])]
  param(
    [Parameter(Mandatory = $true)][string]$id,
  ...
  $endpoint = "/tas/api/operators/id/$($id)/archive"
  $body = @{}
...
#EndRegion '.\Public\Set-TopdeskOperatorArchive.ps1' 21
#Region '.\Public\Set-TopdeskOperatorGroupArchive.ps1' 0
...
#EndRegion '.\Public\Set-TopdeskOperatorGroupArchive.ps1' 23
#Region '.\Public\Set-TopdeskOperatorGroups.ps1' 0
...
#EndRegion '.\Public\Set-TopdeskOperatorGroups.ps1' 130
#Region '.\Public\Set-TopdeskOperatorGroupUnarchive.ps1' 0
...
#EndRegion '.\Public\Set-TopdeskOperatorGroupUnarchive.ps1' 17
#Region '.\Public\Set-TopdeskOperatorSearchList.ps1' 0
function Set-TopdeskOperatorSearchList{
  [CmdletBinding()]
  [OutputType([System.Collections.Generic.List[PSObject]])]
  param(
...
#EndRegion '.\Public\Set-TopdeskOperatorSearchList.ps1' 21
#Region '.\Public\Set-TopdeskOperatorUnArchive.ps1' 0
...
#EndRegion '.\Public\Set-TopdeskOperatorUnArchive.ps1' 16
...
#Region '.\Public\Set-TopdeskPersonGroupArchive.ps1' 0
...
#EndRegion '.\Public\Set-TopdeskPersonGroupArchive.ps1' 23
#Region '.\Public\Set-TopdeskPersonGroupUnarchive.ps1' 0
...
#EndRegion '.\Public\Set-TopdeskPersonGroupUnarchive.ps1' 17
...
#Region '.\Public\Set-TopdeskPersonsSearchList.ps1' 0
...
#EndRegion '.\Public\Set-TopdeskPersonsSearchList.ps1' 21
